...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Már 21. 11:40
...
CREATE TABLE `ajanlat_hotel` (
  ...
  `ajanlat_hotel_nev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
...
CREATE TABLE `ajanlat_varos` (
  ...
  `ajanlat_nev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `ajanlat_nap` varchar(25) COLLATE utf8_hungarian_ci NOT NULL,
  `ajanlat_ar` int(11) NOT NULL,
  `ajanlat_varosnev` varchar(25) COLLATE utf8_hungarian_ci NOT NULL,
  `ajanlat_kep` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `ajanlat_leiras` varchar(1000) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `auto` (
  ...
  `auto_akcio` varchar(11) COLLATE utf8_hungarian_ci NOT NULL,
  `auto_ar` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `auto_akcios_ar` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `auto_pontozas` float NOT NULL,
  `auto_napiar` varchar(1000) COLLATE utf8_hungarian_ci NOT NULL,
  `auto_adatok` varchar(100) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `felhasznalok` (
  ...
  `felhasznalo_id` varchar(25) COLLATE utf8_hungarian_ci NOT NULL,
  `felhasznalo_jelszo` varchar(100) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `felhasznalok` (`felhasznalo_foid`, `felhasznalo_id`, `felhasznalo_jelszo`) VALUES
(1, '123456', 'valami'),
(2, '1234567', 'valami2');
...
CREATE TABLE `felhasznaloutazas` (
  ...
  `felhasznaloutazas_ajanlathonnanvaros` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `felhasznaloutazas_ajanlathovavaros` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `felhasznaloutazas_kivalasztottdatum` date NOT NULL,
  `felhasznaloutazas_hazamenetdatum` date NOT NULL,
  `felhasznaloutazas_fodarab` varchar(11) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
(12, 123456, 'Debrecen', 'London', '2023-03-10', '2023-03-20', '5'),
(13, 123456, 'Debrecen', 'London', '2023-03-10', '2023-03-20', '5'),
(14, 123456, 'Debrecen', 'London', '2023-03-10', '2023-03-20', '5'),
(15, 123456, 'Debrecen', 'London', '2023-03-10', '2023-03-20', '5'),
(16, 123456, 'Debrecen', 'London', '2023-03-10', '2023-03-20', '5'),
(17, 123456, '', 'London', '2023-03-19', '2023-03-29', '5'),
(18, 123456, '', 'London', '2023-03-19', '2023-03-29', '5'),
(19, 123456, 'Budapest', 'London', '2023-03-19', '2023-03-29', '5'),
(20, 123456, '', 'London', '2023-03-19', '2023-03-29', '5'),
(21, 123456, '', 'London', '2023-03-19', '2023-03-29', '5'),
(22, 123456, '', 'London', '2023-03-19', '2023-03-29', '5');
...
CREATE TABLE `feltoltes` (
  ...
  `auto_id` int(11) NOT NULL,
  `feltoltes_kep` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
  `feltoltes_ar` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
...
CREATE TABLE `orszagok` (
  ...
  `orszag_nev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `orszag_kep` varchar(25) COLLATE utf8_hungarian_ci NOT NULL,
  `orszagkep1_1` varchar(50) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
INSERT INTO `orszagok` (`orszag_id`, `orszag_nev`, `orszag_kep`, `orszagkep1_1`) VALUES
...
CREATE TABLE `varosok` (
  ...
  `varos_nev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
...
ALTER TABLE `felhasznaloutazas`
  ...
  ADD KEY `felhasznaloutazas_ajanlathovavaros` (`felhasznaloutazas_ajanlathovavaros`),
  ADD KEY `felhasznaloutazas_ajanlathovav_2` (`felhasznaloutazas_ajanlathovavaros`),
...
--
ALTER TABLE `felhasznaloutazas`
  MODIFY `felhasznaloutazas_kivalasztott_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
-- Megkötések a táblához `felhasznaloutazas`
--
ALTER TABLE `felhasznaloutazas`
  ADD CONSTRAINT `felhasznaloutazas_ibfk_2` FOREIGN KEY (`felhasznaloutazas_ajanlathovavaros`) REFERENCES `ajanlat_varos` (`ajanlat_varosnev`);
